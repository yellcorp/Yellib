...
public class HashMap {
    ...
    public function hasKey(key:IHashable):Boolean {
    ...
    public function setItem(key:IHashable, value:*):void {
    ...
    public function getItem(key:IHashable, notFoundValue:* = null):* {
        var bucket:Array = getBucket(key);
        var index:int = -1;
    ...
    public function remove(key:IHashable):Boolean {
        var bucket:Array = getBucket(key);
        var index:int = -1;
    ...
    private function getBucket(key:IHashable):Array
    {
        return dict[key.hash()];
    }

    private function getBucketNew(key:IHashable):Array
    {
        var hash:* = key.hash();
    ...
    private function getKeyIndex(bucket:Array, key:IHashable):int {
        var index:int;
    ...
    private function getValueIndex(bucket:Array, key:IHashable):int {
