...
/**
 * This class captures the state of a filter or filters as authored in the
 * Flash IDE, and generates AS3 code to reconstruct them.  Intended as a
 * development aid and not a runtime library.
 */
