package org.yellcorp.lib.storage
{
...
public dynamic class LocalSharedObjectProxy extends Proxy
{
    ...
    public function LocalSharedObjectProxy(
        name:String, localPath:String = null, secure:Boolean = false)
    {
        var copyName:String;
        runtime = new Object();
        ...
        {
            persistValid = false;
            trace("LocalSharedObjectProxy: " +
                "Error instantiating SharedObject: " +
                e.toString());
        }
    }
